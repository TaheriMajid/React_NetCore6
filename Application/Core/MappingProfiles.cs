    ...
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
            ...
            .ForMember(dest => dest.HostUsername,
                        opt => opt.MapFrom(src => src.Attendees.FirstOrDefault(x => x.IsHost)
                        .AppUser.UserName));
            ...
            .ForMember(dest => dest.Following,
                        opt => opt.MapFrom(
                        src => src.AppUser.Followers.Any(x => x.Observer.UserName == currentUsername)));
            ...
            .ForMember(dest => dest.HostUsername, opt => opt.MapFrom(src => src.Activity.Attendees
